...
const getCurrentResidences = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { cognitoId } = req.params;
        const residences = yield prisma.property.findMany({
            where: { tenants: { some: { cognitoId } } },
            include: { location: true },
        });
        const residencesWithFormattedLocation = yield Promise.all(residences.map((residence) => __awaiter(void 0, void 0, void 0, function* () {
            var _a;
            const coordinates = yield prisma.$queryRaw `SELECT ST_asText(coordinates) as coordinates FROM "Location" where id=${residence.location.id}`;
            const geoJSON = (0, wkt_1.wktToGeoJSON)(((_a = coordinates[0]) === null || _a === void 0 ? void 0 : _a.coordinates) || "");
            const longitude = geoJSON.coordinates[0];
            const latitude = geoJSON.coordinates[1];
            return Object.assign(Object.assign({}, residence), { location: Object.assign(Object.assign({}, residence.location), { coordinates: { longitude, latitude } }) });
        })));

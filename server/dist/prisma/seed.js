...
function resetSequence(modelName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield prisma.$executeRaw(client_1.Prisma.raw(`SELECT setval(pg_get_serial_sequence('${quotedModelName}', 'id'), coalesce(max(id)+1, ${nextId}), false) FROM ${quotedModelName};`));
